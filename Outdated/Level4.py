    ...
    def run(self):
        ...
        while running:
            ...
            hud.update(currentWave, score, maxScore, self.player.health, self.player.maxHealth, self.player.lives,
                       self.player.damage, 600 - sBooster, self.player.bspeed)
        ...
        while running:
            ...
            # PLAYER BULLETS AND ENEMY COLLISION
            hits = py.sprite.groupcollide(self.enemies, self.bullets, False, False)
            for enemy, bullet_list in hits.items():
                for bullet in bullet_list:
        ...
        py.time.set_timer(self.ADDENEMY, 700)
